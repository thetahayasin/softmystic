                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input id="db_connection" name="db_connection" value="{{ old('db_connection', env('DB_CONNECTION', 'mysql')) }}" required
                                class="mt-1 block w-full border border-gray-300 outline-2 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3 @error('db_connection') border-red-500 @enderror" />
                        ...
                        <div>
                            ...
                            <input id="db_host" name="db_host" value="{{ old('db_host', env('DB_HOST', '127.0.0.1')) }}" required
                                class="mt-1 block w-full border border-gray-300 outline-2 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3 @error('db_host') border-red-500 @enderror" />
                        ...
                        <div>
                            ...
                            <input id="db_port" name="db_port" value="{{ old('db_port', env('DB_PORT', '3306')) }}" required
                                class="mt-1 block w-full border border-gray-300 outline-2 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3 @error('db_port') border-red-500 @enderror" />
                        ...
                        <div>
                            ...
                            <input id="db_database" name="db_database" value="{{ old('db_database', env('DB_DATABASE')) }}" required
                                class="mt-1 block w-full border border-gray-300 outline-2 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3 @error('db_database') border-red-500 @enderror" />
                        ...
                        <div>
                            ...
                            <input id="db_username" name="db_username" value="{{ old('db_username', env('DB_USERNAME')) }}" required
                                class="mt-1 block w-full border border-gray-300 outline-2 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3 @error('db_username') border-red-500 @enderror" />
                        ...
                        <div>
                            ...
                            <input id="db_password" name="db_password" value="{{ old('db_password', env('DB_PASSWORD')) }}" type="password"
                                class="mt-1 block w-full border border-gray-300 outline-2 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3 @error('db_password') border-red-500 @enderror" />
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input id="app_name" name="app_name" value="{{ old('app_name', env('APP_NAME', 'MyApp')) }}" required
                                class="mt-1 block w-full border border-gray-300 outline-2 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3 @error('app_name') border-red-500 @enderror" />
                        ...
                        <div>
                            ...
                            <input id="app_url" name="app_url" value="{{ old('app_url', env('APP_URL', 'http://localhost')) }}" required
                                class="mt-1 block w-full border border-gray-300 outline-2 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3 @error('app_url') border-red-500 @enderror" />
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input id="mail_mailer" name="mail_mailer" value="{{ old('mail_mailer', env('MAIL_MAILER', 'smtp')) }}"
                                class="mt-1 block w-full border border-gray-300 outline-2 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3 @error('mail_mailer') border-red-500 @enderror" />
                        ...
                        <div>
                            ...
                            <input id="mail_host" name="mail_host" value="{{ old('mail_host', env('MAIL_HOST', 'mailpit.local')) }}"
                                class="mt-1 block w-full border border-gray-300 outline-2 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3 @error('mail_host') border-red-500 @enderror" />
                        ...
                        <div>
                            ...
                            <input id="mail_port" name="mail_port" value="{{ old('mail_port', env('MAIL_PORT', '1025')) }}"
                                class="mt-1 block w-full border border-gray-300 outline-2 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3 @error('mail_port') border-red-500 @enderror" />
                        ...
                        <div>
                            ...
                            <input id="mail_username" name="mail_username" value="{{ old('mail_username', env('MAIL_USERNAME')) }}"
                                class="mt-1 block w-full border border-gray-300 outline-2 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3 @error('mail_username') border-red-500 @enderror" />
                        ...
                        <div>
                            ...
                            <input id="mail_password" name="mail_password" value="{{ old('mail_password', env('MAIL_PASSWORD')) }}" type="password"
                                class="mt-1 block w-full border border-gray-300 outline-2 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3 @error('mail_password') border-red-500 @enderror" />
                        ...
                        <div>
                            ...
                            <input id="mail_encryption" name="mail_encryption" value="{{ old('mail_encryption', env('MAIL_ENCRYPTION', 'tls')) }}"
                                class="mt-1 block w-full border border-gray-300 outline-2 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3 @error('mail_encryption') border-red-500 @enderror" />
                        ...
                        <div>
                            ...
                            <input id="mail_from_address" name="mail_from_address" value="{{ old('mail_from_address', env('MAIL_FROM_ADDRESS', 'hello@example.com')) }}" required
                                class="mt-1 block w-full border border-gray-300 outline-2 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3 @error('mail_from_address') border-red-500 @enderror" />

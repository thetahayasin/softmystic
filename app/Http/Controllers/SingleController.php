...
class SingleController extends Controller
{
    public function index($param1 = null, $param2 = null, $param3 = null)
    {
        ...
        $software = Software::with([
            ...
            'license.licenseTranslations' => function ($q2) use ($locale_id) {
                $q2->select('id', 'license_id', 'locale_id', 'name', 'description')
                   ->where('locale_id', $locale_id);
            },
        ...
        {
            $meta_title = $this->parseShortcodes($trns->single_meta_title ?? '', $software, $trns);
            $meta_description = $this->parseShortcodes($trns->single_meta_description ?? '', $software, $trns);
        }
        else
        {
            $meta_title = '';
        ...
        foreach ($locales as $loc) {
            ...
            $url = $this->generateSingleUrl($alt_locale_slug, $platform_slug, $software->slug, $default_locale_slug, $default_platform_slug);
